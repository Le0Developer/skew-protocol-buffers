(function() {
  ...
  proto.Writer.writeInt32 = function(self, fieldNumber, value) {
    proto.Writer.writeTag(self, proto.TagLengthValue.$new(proto.Tag.I32, fieldNumber));
    proto.Writer.write1(self, value & 255);
    proto.Writer.write1(self, value >> 8 & 255);
    proto.Writer.write1(self, value >> 16 & 255);
    proto.Writer.write1(self, value >> 24 & 255);
  };
  ...
  tutorial.Person.marshal = function(self) {
    ...
    if (in_Option.isSome(self.__age)) {
      proto.Writer.writeInt32(writer, 9, proto.internal_encoding.Float.encode(in_Option.unwrapUnchecked(self.__age)));
    }
  ...
  tutorial.Person.PhoneNumber = function() {
    this.__type = tutorial.Person.PhoneType.WORK;
    this.__number = '+1234567890';
    this._unknownFields = [];
  };
  ...
  tutorial.Person.PhoneNumber.marshal = function(self) {
    var writer = proto.Writer.$new();
    proto.Writer.writeString(writer, 1, self.__number);
    proto.Writer.writeVarInt2(writer, 2, self.__type);
    proto.Writer.write2(writer, self._unknownFields);
    return proto.Writer.buffer(writer);
  };
  ...
  tutorial.Person.PhoneNumber.unmarshal1 = function(reader) {
    ...
    while (!proto.Reader.done(reader)) {
      ...
      switch (proto.TagLengthValue.fieldNumber(tag)) {
        case 2: {
          assert(proto.TagLengthValue.tag(tag) == proto.Tag.VARINT);
          message.__type = proto.Reader.readVarInt(reader);
          break;
        }

        case 1: {
          assert(proto.TagLengthValue.tag(tag) == proto.Tag.LEN);
          message.__number = proto.Reader.readString(reader);
          break;
        }
